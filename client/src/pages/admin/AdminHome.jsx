  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (sectionsData.success) {
        setCollections(sectionsData.sections || []);
      }
        ...
        <section className="mt-8 overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm">
          ...
          <form onSubmit={saveCollection} className="p-6 lg:p-8">
            ...
            <div className="mt-10 border-t border-zinc-100 pt-8">
              ...
              {products.length > 0 ? (
                <div className="mt-4 grid max-h-[360px] gap-3 overflow-y-auto rounded-2xl border border-zinc-200 bg-zinc-50 p-3 sm:grid-cols-2 lg:grid-cols-3">
  ...
  return (
    <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
      ...
      <button
        type="button"
        onClick={onCreate}
        className="inline-flex w-fit items-center gap-2 rounded-xl bg-red-600 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-red-600/20 transition hover:-translate-y-0.5 hover:bg-red-700"
      >
